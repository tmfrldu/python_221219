...
print('{} {} {}'.format(10,20,30)) # 중괄호 갯수 = 변수 갯수
print("{:+d}".format(52))
print("{:+d}".format(-52))
...
print(f'{" f문자열 포매팅 ":=^20}')
# f문자열 포매팅_ 변수가 밖에 이미 선언되어 있을 경우
city = 'Seongnam'
...
print("hello world".find('l'))  # l이 가장 먼저 위치한 곳의 index 반환, 없으면 -1 반환
print("hello world".rfind('l')) # l이 가장 늦게 위치한 곳의 위치 index 반환, 없으면 -1 반환
